...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="task-list__input-name";
...
var editTask=function(){
    ...
    var editInput=listItem.querySelector(".task-list__input-name");
...
//select ListItems children
    var checkBox=taskListItem.querySelector(".task-list__checkbox-input");
